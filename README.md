...
| PYTHON (testing) |bibliotecas p/ testes automatizados:<br>- doctest<br>- pytest
|PYTHON (Django)|	- Criação de projetos e aplicativos <br> - Gerenciamento de URLs <br> - Segurança <br> - Gerenciamento de Banco de Dados <br> - Escalabilidade de aplicações Django - (Celery & RabbitMQ)<br>- Desenvolvimento de APIs básicas <br> - Utilização do Django REST Framework (Introdução, paginação, serialização, integração com outras bibliotecas e frameworks)
|PYTHON (Django "APIs")|	- Conceitos básicos de REST e RESTful API design<br>- Criação e implementação de endpoints avançados <br>- Autenticação e autorização de APIs<br>- Validação de entrada de dados<br>- Tratamento de erros e exceções<br>- Documentação de APIs com ferramentas como OpenAPI/Swagger<br>- Integração de APIs com outros sistemas e serviços<br>- Testes de APIs automatizadas<br>- Publicação de APIs<br>- Segurança de APIs <br>- Monitoramento de APIs<br>- Versionamento de APIs<br>- Escalabilidade de APIs
...
| DATA RETRIEVAL | ElasticSearch (SearchEngine)
