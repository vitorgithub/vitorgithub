...
| **PROGRAMAÇÃO:**                                    | <br> **PYTHON**<br> ➥ Data Structures & Algorithms <br> ➥ Programming Paradigm - (OOP)<br>➥ Design Principle - (S.O.L.I.D)<bR> ➥ Design Patterns <br>➥ Frameworks - (Django & FastApi)<br>➥ APIs - (Postman)<br>➥ ORM - (SQL Alchemy)<Br>➥ TDD | <Br>**Segurança no Processo e Desenvolvimento de Software:**<br> ➥ Especificar requisitos de software orientados a riscos<br>➥ Especificar segurança, confiabilidade e proteção de software<br>➥ Codificar para web com segurança<br>➥ Codificar regras de negócio com segurança                            |
