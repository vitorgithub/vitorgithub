...
| :--- | :-- | :-- |  :-- | :-- | :-- | 
|**ONLINE SERVICES**<Br>- APIs<br><br>**SGBD SQL**<br>- MySQL, <br>- Postgres,<bR>-  AWS Aurora<br><Br>**SGBD NoSQL (document)**<br> - Azure Cosmos DB, <br> - MongoDB<bR>- ElasticSearch (data retrieval)<br><br>**SGBD NoSQL (wide-column)**<br>- Google Bigtable, <br> - Apache HBase,<br> - Apache Cassandra<br><br>**SGBD NoSQL (graph)**<br>- AWS Neptune<br><br>**SGBD NoSQL (key-value)**<br>- AWS DynamoDB, <br> - Redis<br><br>**TELEMETRIA**<br><br>**PARCEIROS**| **Data Lake (Storage for Pre-processing)**<br>- AWS S3<br>- Azure Blob Storage Gen2 <br>- Google Cloud Storage<br><Br>**Event Streaming**<br>- Apache Kafka (c/ RabbitMQ)<br>- AWS Kinesis (c/ AWS SNS & SQS)<br>- Azure Event Hubs<br><br>**Data Movement**<br>- Apache NiFi<br>- StreamSets<br>- Talend<br>- AWS Glue<br>- Google Cloud Dataflow<bR><bR>**Messaging**<br>- RabbitMQ<br>- AWS SNS & SQS<br>- Google PubSub<br>- Azure Service Bus| **Batch Processing:**<br>- data build tool<br>- Apache Pig<br><br>**Hybrid Processing:**<br>- Apache Beam<br>- Apache Spark (Databricks)<br>- Apache Flink<br><br>**Stream Processing:**<br>- Apache Kafka<br>- Apache Storm<br>- AWS Kinesis|**Data Lake (Storage for Post-processing)**<br>- Delta Lake<br>- Apache Hudi<br>- Apache Iceberg<br><br>**Data Warehouses** <br>- Google BigQuery<br>- Azure Synapse<br>- AWS Redshift<br>- Snowflake<br><br>**Data Marts**<br>- Apache Druid & Apache Pinot<br><br>**Distributed File Systems**<br>- Apache HDFS<br>- Azure Data Lake Storage<br>- Google Cloud Storage<br>- AWS S3 | **Workflow scheduling**<br>- Apache Airflow<bR>- Google Composer | **Monitoring data pipelines**<br>- Prometheus<br>- Datadog<br> - Sentry<br>- Grafana
